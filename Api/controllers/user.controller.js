const { loginUser, registerUser, checkOldPassword, updatePassword, updateUserProfile, getOneUser } = require("../services/user.service.js");
...
module.exports = {login, register, changePassword, updateProfile, getUser}